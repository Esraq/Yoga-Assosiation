...
<div class="page-content">
    <div class="page">
        <div class="panel">
            <div class="title">
                <h1>অর্ধ-পদ্মাসন বা সুখাসন</h1>

            </div>
            <div class="content">
                <p> এই আসন-পদ্ধতিতে এক পা হাঁটু থেকে ভাঁজ করে অন্য পায়ের উরুর উপর রাখা হলেও অন্য পা মুক্ত-পদ্মাসনের ভঙ্গিতে আরেক পায়ের উপর না উঠিয়ে ভাঁজ করে মাটিতেই রাখা হয়। এই আসনকে সুখাসনও (Sukhasana) বলা হয়ে থাকে।</p>
            </div>
        </div>
    </div>
    <div class="clear"></div>
